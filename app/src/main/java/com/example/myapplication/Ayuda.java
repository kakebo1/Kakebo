    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAvisoPriv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String avisoPriv = getString(R.string.AvisodePriv);
                Spanned textoEstilizado = Html.fromHtml(avisoPriv, Html.FROM_HTML_MODE_LEGACY);
                builder.setTitle("Aviso de privacidad");
                builder.setMessage(textoEstilizado);
        ...
        btnTyC.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String tyc = getString(R.string.TerminosyCond);
                Spanned textoEstilizadoTyC = Html.fromHtml(tyc, Html.FROM_HTML_MODE_LEGACY);
                builder.setTitle("Términos y Condiciones");
                builder.setMessage(textoEstilizadoTyC);
                builder.setCancelable(false);
                builder.setPositiveButton("Aceptar", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
