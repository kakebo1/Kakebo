...
//DECLARAR VARIABLES
ImageButton btnAgregarI;
    TextView txtIngPlaneados, txtIngReales, txtQuincena1, txtQuincena2;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAgregarI=(android.widget.ImageButton)findViewById(R.id.btnAgregarI);
        btnAgregarI.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent btnAgregarI = new Intent(Ingresos.this, LlenadoIngresos.class);
                startActivity(btnAgregarI);
            }
        });/** FIN CODIGO EGRESOS**/
