...
TextView txtEgPlaneados, txtEgReales, txtDeudas, txtQuincena1, txtQuincena2;
...
// FIN DECLARAR VARIABLES
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAgregar=(android.widget.ImageButton)findViewById(R.id.btnAgregarI);
        btnAgregar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
               Intent btnAgregar = new Intent(Egresos.this, LlenadoEgresos.class);
